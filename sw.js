const CACHE_NAME = 'animal-quest-v2-01';
const CORE_ASSETS = [
  './',
  './index.html',
  './src/app.js',
  ...
  './data/animals.json',
  './icons/app-emblem.png',
  './icons/app-emblem.webp',
  ...
  './assets/card-backgrounds/card-bg-bugs.webp',
  './assets/card-backgrounds/card-bg-city.webp',
  './assets/card-backgrounds/card-bg-farm.webp',
  './assets/card-backgrounds/card-bg-pets.webp',
  './assets/card-backgrounds/card-bg-wild.webp',
  './assets/card-backgrounds/card-bg-zoo.webp',
  './assets/default-explorer-avatar.webp',
  './assets/default-explorer.webp',
  './assets/locked-backgrounds/locked-bg-bugs.webp',
  './assets/locked-backgrounds/locked-bg-city.webp',
  './assets/locked-backgrounds/locked-bg-farm.webp',
  './assets/locked-backgrounds/locked-bg-pets.webp',
  './assets/locked-backgrounds/locked-bg-wild.webp',
  './assets/locked-backgrounds/locked-bg-zoo.webp',
  './assets/nav/nav-camera-alt.webp',
  './assets/nav/nav-camera.webp',
  './assets/nav/nav-club.webp',
  './assets/nav/nav-journal.webp',
  './assets/nav/nav-map.webp',
  './assets/nav/nav-parent-lock.webp',
  './assets/world-icons/icon-world-bugs.webp',
  './assets/world-icons/icon-world-city.webp',
  './assets/world-icons/icon-world-farm.webp',
  './assets/world-icons/icon-world-pets.webp',
  './assets/world-icons/icon-world-wild.webp',
  './assets/world-icons/icon-world-zoo.webp',
  './assets/worlds/bg-world-bugs.webp',
  './assets/worlds/bg-world-city.webp',
  './assets/worlds/bg-world-farm.webp',
  './assets/worlds/bg-world-pets.webp',
  './assets/worlds/bg-world-wild.webp',
  './assets/worlds/bg-world-zoo.webp'
];
